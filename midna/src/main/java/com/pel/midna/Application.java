...
import com.pel.midna.service.MigrationService;
import com.pel.midna.controller.TournamentController;
import java.io.*;
...
public class Application {
    ...
    public static void main(String[] args) throws SQLException, IOException, FirebaseMessagingException {
        ...
        get("/midna/test", (req, res) -> {
            res.body("{\"message\": \"" + "Midna v" + Constants.VERSION + "\"}");
            return res;
        });
